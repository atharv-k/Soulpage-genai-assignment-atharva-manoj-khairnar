...
# installed.
TCL_PREFIX='E:/GenAI/assign-soulpage/soulpage\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='E:/GenAI/assign-soulpage/soulpage\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='E:/GenAI/assign-soulpage/soulpage\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-IE:/GenAI/assign-soulpage/soulpage\Library\include'
...
TCL_PACKAGE_PATH='E:/GenAI/assign-soulpage/soulpage\Library\lib'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LE:/GenAI/assign-soulpage/soulpage\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='E:/GenAI/assign-soulpage/soulpage\Library\lib\tclstub86.lib'
